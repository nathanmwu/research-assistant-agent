...
- **Question-aware source credibility** — social/UGC sources are excluded outright (a research report never cites a LinkedIn post), and the planner judges per sub-question whether scholarly evidence is warranted: empirical sub-questions prefer academic sources at selection time, landscape sub-questions keep the open web, and any unmet scholarly preference is disclosed in Limitations.
